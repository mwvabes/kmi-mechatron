...
! function (t) {
    ...
    var s, l = n(0),
        ...
        g = function (t) {
            if ("[object Date]" === Object.prototype.toString.call(t)) {
                if (h(t.getTime())) return !0
            } else if (p(t)) {
                var e = new Date(t);
                if (h(e.getTime())) return !0
            }
            return !1
        },
        _ = function (t, e) {
        ...
        D = function () {
            ...
            return o(t, [{
                ...
                value: function (t, e) {
                    ...
                    var n = this.top(1)[0];
                    return this._formatError(n[t], "sort", 'Column name "%s" does not exist in collection', t), this.sortDirection.ASC === e ? this.dataset.sort((function (e, n) {
                        return P(e[t], n[t])
        ...
        L = (n(2), function () {
            function t(e) {
                ...
                i(this, t), this._name = "tableSortable", this._defOptions = {
                    ...
                    n._isMounted || n.init()
                }, this.options = u.a.extend(this._defOptions, e), delete this._defOptions, this._rootElement = u()(this.options.element), this.engine = U(), this.optionDepreciation(), this.init(), this._debounceUpdateTable()
            }
            return o(t, [{
                ...
                value: function (t) {
                    ...
                    b(o, (function (t, n) {
                        var o;
                        o = f(i) ? i(a[t], t, n) : "<span>".concat(a[t], "</span>"), o = e._addColSorting(o, t);
    ...
    window.Pret = U(), window.TableSortable = L, window.DataSet = D, (s = jQuery).fn.tableSortable = function (t) {
